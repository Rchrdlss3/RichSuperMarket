...
RmvPhoto = PhotoImage(master = root,file= 'Supermarket Project/images/RemoveItem.png')
AddPhoto = PhotoImage(master = root,file= 'Supermarket Project/images/AddItem.png')
LogPhoto = PhotoImage(master = loginscreen, file= 'Supermarket Project/images/Login.png')
############################################################################################################################################################
#########################################Log In Screen##############################################################################
############################################################################################################################################################
